...
stocks = ('GOOG', 'AAPL', 'MSFT', 'RPOWER.NS', 'HAPPSTMNDS.NS' ,'APLAPOLLO.NS', 'DEEPAKNTR.NS', 'TATAMOTORS.NS', 'GE', 'RELIANCE.NS', 'CAPLIPOINT.NS', 'TATACHEM.NS', 'TATAPOWER.NS', 'MOTHERSUMI.NS', 'ICICIBANK.NS', 'ZOMATO.NS', 'SBIN.NS', 'TATAELXSI.NS', 'AMARAJABAT.NS', 'EXIDEIND.NS', 'DLF.NS')
